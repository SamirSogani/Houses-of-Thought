...
Return question_level_assumptions (1-8) and cross_perspective_notes (1-2 sentences on the pattern across perspectives that revealed these). Do not just repeat an assumption already listed inside one perspective's own assumptions unless naming it at a genuinely more general level.`

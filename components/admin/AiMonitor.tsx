        ...
        {loading && !snap ? (
          ...
          <>
            ...
            <div className="acct-card-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 16 }}>
              ...
              <Lane title="Swarm lane · reasoning pipeline (DeepInfra-only, temporary)" steps={snap.lanes.swarm} probeByName={probeByName} />
              <Lane title="Synthesis lane · reasoning pipeline final composition (DeepInfra-only, temporary)" steps={snap.lanes.synthesis} probeByName={probeByName} />
            </div>

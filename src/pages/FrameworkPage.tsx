        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 max-w-2xl mx-auto">
            {[
              ...
              {
                title: "Implications",
                description: "Predicted outcomes — what should logically follow if the conclusion is correct.",
                accent: "border-atmosphere bg-atmosphere/5",
              },
              null,
              {
                title: "Consequences",
                description: "Actual real-world outcomes — what observably happens as a result of the conclusion.",

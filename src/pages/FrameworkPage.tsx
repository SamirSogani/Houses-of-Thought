...
const HOUSE_LAYERS = [
  ...
  { id: "question", label: "Sub-Questions", element: "3.2", description: "The central question your analysis seeks to answer.", color: "bg-primary/10 border-primary text-primary", link: "s-question" },

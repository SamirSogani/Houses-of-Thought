      ...
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="prose prose-sm max-w-none text-foreground space-y-8">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">House of Thought (also known as House of Reason) is an AI-powered reasoning platform designed to help users analyze complex questions using structured critical thinking tools. By accessing or using the platform, you agree to be bound by these Terms of Service. If you do not agree, please do not use the platform.</p>
          </section>

          <section>
            <h2 className="text-xl font-display font-semibold mb-2">2. Eligibility</h2>
            <p className="text-muted-foreground leading-relaxed">You must be at least 12 years old to create an account or use House of Thought. If you are under 18, you should have permission from a parent, guardian, or teacher before using the platform.</p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-2">When using House of Thought, you agree not to:</p>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">You are solely responsible for the content you create, upload, or share within the platform. House of Thought does not endorse, verify, or guarantee the accuracy of user-generated content.</p>
          </section>

          <section>
            <h2 className="text-xl font-display font-semibold mb-2">8. Intellectual Property</h2>
            <p className="text-muted-foreground leading-relaxed">House of Thought owns and retains all rights to the platform software, system architecture, design, branding, and proprietary reasoning framework. You retain ownership of your own reasoning projects and content. By using the platform, you grant House of Thought a limited, non-exclusive license to store, process, and display your content solely for the purpose of providing the service.</p>
          </section>

          <section>
            <h2 className="text-xl font-display font-semibold mb-2">9. Service Availability</h2>
            <p className="text-muted-foreground leading-relaxed">House of Thought does not guarantee uninterrupted, error-free, or continuous operation of the platform. The service may occasionally be unavailable due to scheduled maintenance, technical issues, or circumstances beyond our control.</p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">The platform is provided "as is" and "as available" without warranties of any kind, either express or implied. To the fullest extent permitted by law, House of Thought shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of the platform.</p>
          </section>

          <section>
            <h2 className="text-xl font-display font-semibold mb-2">12. Changes to Terms</h2>
            <p className="text-muted-foreground leading-relaxed">House of Thought may update these Terms of Service periodically. We will notify users of significant changes. Continued use of the platform after changes are posted constitutes acceptance of the updated terms.</p>
          </section>

          <section>
            <h2 className="text-xl font-display font-semibold mb-2">13. Contact</h2>
            <p className="text-muted-foreground leading-relaxed">If you have questions about these Terms of Service, please contact us at <a href="mailto:houseofthought.support@gmail.com" className="text-primary hover:underline">houseofthought.support@gmail.com</a>.</p>
          </section>
        </div>
      </div>
      <SiteFooter />

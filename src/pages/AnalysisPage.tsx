  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <aside className="hidden md:flex w-14 shrink-0 border-r border-border bg-card/80 flex-col items-center py-4 gap-2 sticky top-0 h-screen">
        ...
        {/* Research Mode toggle — only for accounts that use the dedicated Research panel (Students), hidden in teacher review */}
        {!teacherReview && permissions.canUseResearchPanel && (
          <button

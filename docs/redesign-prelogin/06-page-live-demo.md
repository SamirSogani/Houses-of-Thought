...
2. **In progress.** The question moves through the eight houses in
   sequence, each room's output streaming in as it's reasoned through.
   The Inspection loop appears at least once, meaningfully — not
   replayed in full for all eight elements, which would turn a strength
   into tedium. Consider an optional "show full inspection" expandable
   for visitors who want the detail.
